...
<body>
    ...
    <ul class="nav nav-tabs bg-dark colorCab" id="navId" style="border:0px; display:flex;">
        <li style="margin:0px; padding-top: 35px">
            <a href="archivoscargados.php" class="nav-link active" style="margin:0px; padding: 0px">
                <h1 style="font-weight:bold">FAEA-111_FiDrive</h1>
            </a>
        </li>
        <li style="margin-left:auto; padding-right:15px; padding-top:15px; color:grey">
            <h1 style="font-weight:bold">Bienvenido <?php echo $usuario ?></h1>
            <?php
            $frase = "";
